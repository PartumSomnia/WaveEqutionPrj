...
figpath = "./figs/"#"/home/vsevolod/GIT/GitLab/projektpraktikum/WaveProject/fig6/"
...
def rhs_characteristis_ghostextrap(phi, pi, x, N, ng):
    ...
    kappa = 0.8
    v_0 = - 1.0  # 0.2
    V = v_0 / ((np.exp(kappa * x + beta) - np.exp(-kappa * x - beta)) / (
                np.exp(kappa * x + beta) + np.exp(-kappa * x - beta))) ** 2 + 1
...
#     rhs = rhs_ghostextrap# rhs_advection_ghostextrap# rhs_periodic# rhs_advection_ghostextrap# rhs_characteristis_ghostextrap
#     list_resolutions = [401]
#     lss = ["-"]
#     #
#     res = {}
#     #
