...
FIGPATH = "../figs/wave_eq_boundaries/"
...
def task_1_solution_at_different_times_for_different_rhs():
    list_times = [0., 0.5, 2.]
...
if __name__ == '__main__':
    task_1_solution_at_different_times_for_different_rhs()
    task_2_self_convergence()